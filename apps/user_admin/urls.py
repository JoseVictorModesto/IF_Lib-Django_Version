...
from apps.user_admin.views import cadastro_admin, deletar_user_admin, perfil_admin, cad_campus, deletar_campus, editar_campus
from apps.user_admin.views import editar_user_admin, cad_instituicao, editar_perfil_admin, deletar_foto_perfil
from apps.user_admin.views import deletar_instituicao, editar_instituicao, cad_curso, deletar_curso, editar_curso 
